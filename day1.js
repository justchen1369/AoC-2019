...
function calcTotalFuel(num) {
  ...
  while(true) {
    ...
    const fuel = calcFuel(fuelArr[fuelArr.length - 1])
    
    if(fuel < 0) break
    fuelArr.push(fuel)
  }

  return fuelArr.reduce((a, b) => {
    return a + b
  }) - num

}

for(mass of moduleMassArr) {
